...
---------|---------|---------|---------
 ...
 instance_ports | (Required) Ports that your Instances Listen to | list(string) | ["443","3389"]
 ...
 instance_type | (Required) Size of the instance | string | t2.micro
 ...
 operatingsystem | (Required) | string | windows
 environment_servernaming | (Required) Environment for servernaming api | string  |us-test
 system_servernaming | (Required) system for servernaming api | string  | AWSNPD
 ComponentKey_servernaming | (Required) ComponentKey for servernaming api | string  | WEB
